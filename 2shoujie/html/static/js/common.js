...
var login_init=function(){
    if($(".login-cover").size()==0) {
        var login_area = '<div class="login-cover"><div class="login-wr"><div class="login-header"><img class="login-logo" src="/resource/image/logo.png" alt="logo"/>' +
            '<p class="site-name">校园二手街</p><div class="share-buttons"><div id="renren-button">人人网登陆</div><div id="qq-button">微信登陆</div></div></div>' +
            '<div class="login-form-container"><form action=""><input class="input-class" type="text" id="user-name" name="user-name" placeholder="用户名/邮箱"/>' +
            '<!--[if lte IE 9]><input class="input-class pw-text" type="text"/><![endif]--><input class="input-class pw-input" type="password" name="pw" id="pw" placeholder="密码"/>' +
            '<p class="ex clearfix"><label class="rem-wr" for="rem"><input id="rem" name="rem" type="checkbox"/><span>记住我</span></label><a class="forget" href="javascript:void(0);">忘记密码</a>' +
            '</p><button class="submit" type="button">登陆二手街</button></form><a class="reg" href="javascript:void(0);">马上注册</a></div></div></div>' +
            '<div class="reg-cover"><div class="reg-wr"><div class="reg-header"><img class="login-logo" src="/resource/image/logo.png" alt="logo"/>' +
            '<p class="site-name">校园二手街</p></div><div class="reg-form-container"><form action=""><input class="input-class" type="text" id="uname" name="uname" placeholder="用户名"/>' +
